    ...
    return (
        <>
            ...
            <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
                ...
                >
                    <div className="relative flex justify-between w-full items-center px-5 py-2.5 dark:bg-black" style={{}}>
                        <button
                            type="button"
                        ...
                        <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2 ">
                            <Link to="/" className="main-logo flex items-center  shrink-0">
                                <img className="w-32 ltr:-ml-1 rtl:-mr-1 inline" src={logo} alt="logo" />
...
// import logo from '../../../public/assets/logo/AOL LOGO BANGALORE ASHRAM BLACK.png';
// import profile from '../../../public/assets/guruji/register.jpg';
...
//                     }}
//                 >
//                     <div className="relative flex w-full items-center px-5 py-2.5 dark:bg-black" style={{}}>
//                         <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2 ">
//                             <Link to="/" className="main-logo flex items-center shrink-0">
